...
class _SingleFilter(Filter):
    ...
    BOOLEAN_FILTERS = FilterSpecDict({
        ...
        'sequential'  : BoolFilterSpec(lambda t: t['sequential'],
                                       needed_keys=('sequential',),
                                       aliases=('seq',),
                                       description='Torrents that download their pieces in order'),
    ...
    COMPARATIVE_FILTERS = FilterSpecDict({
        ...
        'infohash'        : CmpFilterSpec(value_getter=lambda t: t['hash'],
