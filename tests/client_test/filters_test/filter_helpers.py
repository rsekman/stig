...
class HelpersMixin():
    ...
    def _check_timestamp_with_absolute_times(self, filter_cls, filter_name, key, items):
        ...
        self.assertEqual(tuple(filter_cls('%s<2001' % filter_name).apply(items, key='id')), (4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s<2002' % filter_name).apply(items, key='id')), (1, 4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s<2003' % filter_name).apply(items, key='id')), (1, 2, 4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s<2004' % filter_name).apply(items, key='id')), (1, 2, 3, 4, 5, 8))

        self.assertEqual(tuple(filter_cls('%s<=2000' % filter_name).apply(items, key='id')), (4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s<=2001' % filter_name).apply(items, key='id')), (1, 4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s<=2002' % filter_name).apply(items, key='id')), (1, 2, 4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s<=2003' % filter_name).apply(items, key='id')), (1, 2, 3, 4, 5, 8))

        self.assertEqual(tuple(filter_cls('%s>2000' % filter_name).apply(items, key='id')), (1, 2, 3, 6, 7))
        self.assertEqual(tuple(filter_cls('%s>2001' % filter_name).apply(items, key='id')), (2, 3, 6, 7))
        self.assertEqual(tuple(filter_cls('%s>2002' % filter_name).apply(items, key='id')), (3, 6, 7))
        self.assertEqual(tuple(filter_cls('%s>2003' % filter_name).apply(items, key='id')), (6, 7))

        self.assertEqual(tuple(filter_cls('%s>=2001' % filter_name).apply(items, key='id')), (1, 2, 3, 6, 7))
        self.assertEqual(tuple(filter_cls('%s>=2002' % filter_name).apply(items, key='id')), (2, 3, 6, 7))
        self.assertEqual(tuple(filter_cls('%s>=2003' % filter_name).apply(items, key='id')), (3, 6, 7))
        self.assertEqual(tuple(filter_cls('%s>=2004' % filter_name).apply(items, key='id')), (6, 7))
    ...
    def _check_timestamp_with_constants(self, filter_cls, filter_name, key, items):
        ...
        self.assertEqual(tuple(filter_cls('%s<now' % (filter_name,)).apply(items, key='id')), (8,))
        self.assertEqual(tuple(filter_cls('%s>now' % (filter_name,)).apply(items, key='id')), (1, 2, 3, 5, 6, 7))
        self.assertEqual(tuple(filter_cls('%s<=now' % (filter_name,)).apply(items, key='id')), (4, 8))
        self.assertEqual(tuple(filter_cls('%s>=now' % (filter_name,)).apply(items, key='id')), (1, 2, 3, 4, 5, 6, 7))
        ...
        self.assertEqual(tuple(filter_cls('%s<soon' % (filter_name,)).apply(items, key='id')), (4, 8))
        self.assertEqual(tuple(filter_cls('%s>soon' % (filter_name,)).apply(items, key='id')), (1, 2, 3, 6, 7))
        self.assertEqual(tuple(filter_cls('%s<=soon' % (filter_name,)).apply(items, key='id')), (4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s>=soon' % (filter_name,)).apply(items, key='id')), (1, 2, 3, 5, 6, 7))
        ...
        self.assertEqual(tuple(filter_cls('%s<unknown' % (filter_name,)).apply(items, key='id')), (1, 2, 3, 4, 5, 8))
        self.assertEqual(tuple(filter_cls('%s>unknown' % (filter_name,)).apply(items, key='id')), (7,))
        self.assertEqual(tuple(filter_cls('%s<=unknown' % (filter_name,)).apply(items, key='id')), (1, 2, 3, 4, 5, 6, 8))
        self.assertEqual(tuple(filter_cls('%s>=unknown' % (filter_name,)).apply(items, key='id')), (6, 7))
        ...
        self.assertEqual(tuple(filter_cls('%s<=na' % (filter_name,)).apply(items, key='id')), (1, 2, 3, 4, 5, 6, 7, 8))
        self.assertEqual(tuple(filter_cls('%s>=na' % (filter_name,)).apply(items, key='id')), (7,))
